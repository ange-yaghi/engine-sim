...
ArticulatedPendulumApplication::ArticulatedPendulumApplication() {
    m_r0 = 0.75;
    m_r1 = 1.5;
}
...
void ArticulatedPendulumApplication::initialize() {
...
void ArticulatedPendulumApplication::process(float dt) {
...
void ArticulatedPendulumApplication::render() {
    ...
    const double g_potential =
        10 * (m_pendulum1.m_positionY + m_r0 + m_r1) * m_pendulum1.m_mass +
        10 * (m_pendulum0.m_positionY + m_r0) * m_pendulum0.m_mass;

    std::stringstream ss;
    ss << "Articulated Pendulum Demo\n";
    ss << " - System Energy    \n";
    ss << " - Framerate            \n";
...
void ArticulatedPendulumApplication::drawPendulum(
    double hinge_x,
    double hinge_y,
    double x,
    double y,
